...
import { Gift, Volume2, VolumeX, Sparkles } from 'lucide-react'
...
const regularPrizeConfig = [
  { value: 5, image: "/images/superpremio5.webp", chance: 29 },
  { value: 25, image: "/images/superpremio25.webp", chance: 30},
  { value: 40, image: "/images/superpremio40.webp", chance: 40 },
  { value: 150, image: "/images/superpremio150.webp", chance: 1 },
  { value: 300, image: "/images/superpremio300.webp", chance: 0 },
  { value: 700, image: "/images/superpremio700.webp", chance: 0 },
  { value: 1000, image: "/images/superpremio10000bike.webp", chance: 0 },
  { value: 1000, image: "/images/superpremio1000.webp", chance: 0 },
  { value: 1500, image: "/images/superpremio1500.webp", chance: 0 },
  { value: 10000, image: "/images/superpremio10000.webp", chance: 0 },
  { value: 20000, image: "/images/superpremio20000.webp", chance: 0 },
]

// Configuração de prêmios para bloggers
const bloggerPrizeConfig = [
  { value: 5, image: "/images/superpremio5.webp", chance: 50 },
  { value: 25, image: "/images/superpremio25.webp", chance: 15},
  { value: 40, image: "/images/superpremio40.webp", chance: 10 },
  { value: 150, image: "/images/superpremio150.webp", chance: 5 },
  { value: 300, image: "/images/superpremio300.webp", chance: 5 },
  { value: 700, image: "/images/superpremio700.webp", chance: 5 },
  { value: 1000, image: "/images/superpremio10000bike.webp", chance: 5 },
  { value: 1000, image: "/images/superpremio1000.webp", chance: 5 },
  { value: 1500, image: "/images/superpremio1500.webp", chance: 0 },
  { value: 10000, image: "/images/superpremio10000.webp", chance: 0 },
  { value: 20000, image: "/images/superpremio20000.webp", chance: 0 },
]
...
const regularConfig = {
  winFrequency: 0.3, // 30% de chance de ganhar
...
"R$5": "/images/superpremio5.webp",
"R$25": "/images/superpremio25.webp",
"R$40": "/images/superpremio40.webp",
"R$150": "/images/superpremio150.webp",
"R$300": "/images/superpremio300.webp",
"R$700": "/images/superpremio700.webp",
"R$1000": "/images/superpremio10000bike.webp",
"R$1000": "/images/superpremio1000.webp",
"R$1500": "/images/superpremio1500.webp",
"R$10000": "/images/superpremio10000.webp",
"R$20000": "/images/superpremio20000.webp",
}

const winMessages = [
  "Super prêmio! Ganhou R$@valor@!",
  "Parabéns! Você conquistou R$@valor@!",
  "Que sorte incrível! R$@valor@ na sua conta!",
]

const loseMessages = [
  "Não foi desta vez, mas continue tentando!",
  "Continue jogando, o super prêmio está chegando!",
...
{ name: "Honda CG", value: 20000, image: "/images/superpremio20000.webp" },
{ name: "Pop 110", value: 10000, image: "/images/superpremio10000.webp" },
{ name: "Patinete Elétrico", value: 1500, image: "/images/superpremio1500.webp" },
{ name: "HooverBoard", value: 1000, image: "/images/superpremio10000bike.webp" },
{ name: "Bicicleta", value: 1000, image: "/images/superpremio1000.webp" },
{ name: "Patins Profissional", value: 700, image: "/images/superpremio700.webp" },
{ name: "Roupa Esportiva Motoqueiro", value: 300, image: "/images/superpremio300.webp" },
{ name: "Capacete", value: 150, image: "/images/superpremio150.webp" },
{ name: "Suporte de Celular", value: 40, image: "/images/superpremio40.webp" },
{ name: "Kit Aromatizador", value: 25, image: "/images/superpremio25.webp" },
{ name: "Cabo de Carregador", value: 5, image: "/images/superpremio5.webp" },
]

export default function SuperPremiosPage() {
    ...
    for (let i = 0; i < NUM_CELLS; i++) {
      ...
      if (symbolElement) {
        ...
        if (symbolText === winningSymbol) {
          ...
          symbolElement.style.boxShadow = "0 0 25px rgba(249, 115, 22, 0.8), inset 0 0 25px rgba(249, 115, 22, 0.3)"
          symbolElement.style.border = "3px solid #F97316"
          symbolElement.style.backgroundColor = "rgba(249, 115, 22, 0.15)"
          symbolElement.style.transform = "scale(1.05)"
          symbolElement.style.zIndex = "10"
          const img = symbolElement.querySelector("img")
          if (img) {
            img.style.filter = "brightness(1.3) drop-shadow(0 0 10px rgba(249, 115, 22, 0.8))"
          }
        }
      }
    }
  ...
  const processGameResult = async () => {
    try {
      const response = await AuthClient.makeAuthenticatedRequest("/api/games/super-premios/play", {
        method: "POST",
  ...
  const initGame = async () => {
    ...
    try {
      ...
      setMessage("Clique ou arraste para raspar os super prêmios!")
      setShowModal(false)
      ...
      gameContainer.className =
        "relative w-full aspect-square bg-gray-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border-2 border-orange-400/30 shadow-2xl shadow-orange-500/10"
      const symbolsGrid = document.createElement("div")
      symbolsGrid.className = "absolute inset-0 grid grid-cols-3 gap-2 p-3"
      for (let i = 0; i < NUM_CELLS; i++) {
        const cellContent = document.createElement("div")
        cellContent.className =
          "flex flex-col justify-center items-center text-orange-300 font-bold bg-gray-800/70 rounded-lg p-1 opacity-0 scale-75 transition-all duration-300"
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-orange-900/20 to-gray-900 opacity-70"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(249,115,22,0.1)_0,_transparent_60%)]"></div>
      ...
      <main className="relative z-10 max-w-md mx-auto px-4 py-8 min-h-screen flex flex-col justify-center">
        <div className="text-center mb-6">
          ...
          <p className="text-orange-200/80 mt-1">Os melhores prêmios! Encontre 3 símbolos iguais!</p>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          {!gameActive && (
            <Button
              ...
              className="w-full font-bold py-3 text-lg bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg shadow-lg shadow-orange-500/30 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:scale-100"
            >
              {gameLoading
                ? "Preparando..."
        ...
        <div className="flex items-center justify-between text-sm mt-8 text-gray-400">
          ...
          <Button
            ...
            className="text-gray-400 hover:text-orange-400 h-8 w-8 rounded-full"
          >
        ...
        <div className="mt-8 bg-gray-800/50 rounded-lg p-4">
          <h3 className="text-xl font-bold text-orange-400 mb-4 text-center uppercase">
